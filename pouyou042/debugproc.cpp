...
void CDebugProc::Update(void)
{
	...
	//操作方法
	CDebugProc::Print("\n～デバッグ用操作方法～\n");
	CDebugProc::Print("[F3]：投影切り替え\n");
	CDebugProc::Print("[F4]：プレイヤーの状態切り替え\n");
	CDebugProc::Print("[4,5]：体力の減少・増加\n");
	CDebugProc::Print("[7,8]：弾切り替え\n\n");
	CDebugProc::Print("[ENTER]：画面遷移\n");

	CDebugProc::Print("\n～プレイヤー操作方法～\n");
	CDebugProc::Print("[A,D]：移動\n");
	CDebugProc::Print("[SPACE]：ジャンプ\n");
	CDebugProc::Print("[I,K,J,L]：弾発射(縦横)\n");
	CDebugProc::Print("[U,O,M,.]：弾発射(斜め)\n");
