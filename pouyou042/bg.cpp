...
CBg *CBg::Create(void)
{
	...
	//初期化処理
	pCBg->Init(D3DXVECTOR3(0.0f,0.0f,0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
...
//背景の初期化処理
//==============================================================
HRESULT CBg::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
	...
	//位置設定
	CObject2D::SetPosition(CObject::TYPE_NONE, m_pos, WIDTH_BG, HEIGHT_BG);
