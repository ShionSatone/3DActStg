...
CParticle *CParticle::Create(D3DXVECTOR3 pos, D3DXCOLOR col, int type, int nLife, float fRadius)
{
	...
	//初期化処理
	pParticle->Init(pos, D3DXVECTOR3(0.0f,0.0f,0.0f));
...
//パーティクルの初期化処理
//==============================================================
HRESULT CParticle::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
...
void CParticle::Set(D3DXVECTOR3 pos, D3DXCOLOR col, int type, int nLife, float fRadius)
{
	...
	case PARTICLETYPE_WATER:	//水
		...
		CParticle::GenerateWater(pos, col, m_type, nLife, fRadius);

		break;

	case PARTICLETYPE_ICE:		//氷

		CParticle::GenerateIce(pos, col, m_type, nLife, fRadius);

		break;

	case PARTICLETYPE_VAPOR:	//蒸気

		CParticle::GenerateVapor(pos, col, m_type, nLife, fRadius);
