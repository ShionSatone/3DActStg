...
CBillboard *CBillboard::Create(void)
{
	...
	//初期化処理
	pBillboard->Init(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
...
//ビルボードの初期化処理
//==============================================================
HRESULT CBillboard::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
...
//ビルボードの色設定処理
//==============================================================
void CBillboard::SetColor(TYPE type, D3DXCOLOR col)
{
	VERTEX_3D *pVtx;		//頂点情報へのポインタ
...
//アニメーション設定処理
//==============================================================
void CBillboard::SetType(TYPE type, int nPatternAnim)
{
	VERTEX_3D *pVtx;		//頂点情報へのポインタ
