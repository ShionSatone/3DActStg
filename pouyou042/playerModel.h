...
public:
	...
	void ControlHumanKeyboard(void);		//プレイヤーキーボード操作(人間)
	...
	void SetWeaponType(int type) { m_particleType = type; }		//武器の種類設定
	int GetWeaponType(void) { return m_particleType; }		//武器の種類取得
