...
CObject2D *CObject2D::Create(void)
{
	...
	//初期化処理
	pObject2D->Init(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
...
//オブジェクト2Dの初期化処理
//==============================================================
HRESULT CObject2D::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
...
//オブジェクト2Dの位置設定処理
//==============================================================
void CObject2D::SetPosition(TYPE type, D3DXVECTOR3 pos, float fWidth, float fHeight)
{
	VERTEX_2D *pVtx;		//頂点情報へのポインタ
...
//オブジェクト2Dの色設定処理
//==============================================================
void CObject2D::SetColor(TYPE type, D3DXCOLOR col)
{
	VERTEX_2D *pVtx;		//頂点情報へのポインタ
...
//アニメーション設定処理
//==============================================================
void CObject2D::SetType(TYPE type, int nPatternAnim)
{
	VERTEX_2D *pVtx;		//頂点情報へのポインタ
...
//背景設定処理
//==============================================================
void CObject2D::SetType(float fTexU, float fTexV)
{
	VERTEX_2D * pVtx;		//頂点情報へのポインタ
