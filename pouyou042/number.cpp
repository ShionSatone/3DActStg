...
CNumber *CNumber::Create(void)
{
	...
	//初期化処理
	pNumber->Init(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
...
//数字の初期化処理
//==============================================================
HRESULT CNumber::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
...
//テクスチャ座標の設定処理
//==============================================================
void CNumber::SetTex(TYPE type, int nPatternAnim, float fDigitX)
{
	VERTEX_2D *pVtx;		//頂点情報へのポインタ
